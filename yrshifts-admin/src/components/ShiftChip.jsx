...
export default function ShiftChip({
  ...
  const hasConflict = (() => {
    ...
    // Specific dates off (all-day)
    if (instructor.unavailableDates?.includes(shift.date)) return true
      ...
      style={{
        ...
        borderColor: isClaim
          ...
          : chipColor
            ...
            : 'var(--border)',
        cursor: "url(\"data:image/png;base64,\") 8 0, grab",
      }}
    >
      {/* Status dot */}
      {dotColor && (
